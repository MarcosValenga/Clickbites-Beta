...
class EditProfileAluno
{
    ...
    {
        $viewProfile = new \App\sistcb\Models\alunos\SistcbEditProfile();
        $viewProfImg = new \App\sistcb\Models\alunos\SistcbEditProfileImage();
        $viewProfPass = new \App\sistcb\Models\alunos\SistcbEditProfilePassword();
    ...
    {
        $loadView = new \Core\ConfigView("sistcb/Views/alunos/editProfileAluno", $this->data);
    ...
    private function editProfile(): void
    {
        ...
        $editProfile = new \App\sistcb\Models\alunos\SistcbEditProfile();
        $editProfile->update($this->dataForm);

        if ($editProfile->getResult()) {
            $urlRedirect = URLADM . "view-profile-aluno/index/" . $_SESSION['user_id'];
            header("Location: $urlRedirect");
        } else {
    ...
    private function editProfImage(): void
    {
        ...
        $editProfImg = new \App\sistcb\Models\alunos\SistcbEditProfileImage();
    ...
    private function editProfPass(): void
    {
        ...
        $editProfPass = new \App\sistcb\Models\alunos\SistcbEditProfilePassword();
