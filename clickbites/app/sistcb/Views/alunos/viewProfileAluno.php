    ...
    <div class="row-rl-tr">
        <div class="top-list">
            ...
            <div class="top-list-right">
                ...
                if (!empty($this->data['viewProfile'])) {
                    echo "<a id='link-rl-tr' href='".URLADM."edit-profile-aluno/index/".$_SESSION['user_id']."' class='btn-warning'>Editar</a> ";
                }
                ?>
            </div>
        </div>
        ...
        <div class="content-adm">
            ...
            ?>
                ...
                <div class="view-det-adm">
                    <span class="view-adm-title">Sala Associada: </span>
                    <span class="view-adm-info"><?php if (!empty($nome_sala)){echo $nome_sala;}else{echo "Não há vinculos";} ?></span>
                </div>
